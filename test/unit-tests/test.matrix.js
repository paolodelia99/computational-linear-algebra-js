...
describe('Test qr decomposition', () => {
  ...
  it('should give the qr decomposition for non square matrices', function () {
    const a = new Matrix([
    ...
    const res = {
      ...
      R: [
        [1.6536529412183196, 1.14046790774039, 1.2569775847092794],
        [-7.567369463069535e-17, 0.9660948822006336, 0.6341076484067485],
        [
          -7.348625413816546e-17,
          -6.675758454542874e-17,
          -0.8815566072411282
        ],
        [0, 0, 0],
        [0, 0, 0]
    ...
    assert.deepStrictEqual(a.qrDecomposition(), res)
  })
})
